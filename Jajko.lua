...
local Window = Rayfield:CreateWindow({
    ...
    KeySettings = {
       ...
       Key = {"fzg02cye8wk3n1rbv2yf3joq55z6q3j7t"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
    }
 })
