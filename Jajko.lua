...
local Window = Rayfield:CreateWindow({
    ...
    Discord = {
       Enabled = true,
       Invite = "https://discord.gg/c7UfkMmnEs", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
    ...
    KeySettings = {
       Title = "Jajko1337",
       Subtitle = "Key System",
       Note = "https://discord.gg/c7UfkMmnEs",
